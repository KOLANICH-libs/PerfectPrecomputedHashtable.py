...
==============================
~~[wheel (GitLab)](https://gitlab.com/KOLANICH-libs/PerfectPrecomputedHashtable.py/-/jobs/artifacts/master/raw/dist/PerfectPrecomputedHashtable-0.CI-py3-none-any.whl?job=build)~~
...
~~![GitLab Build Status](https://gitlab.com/KOLANICH-libs/PerfectPrecomputedHashtable.py/badges/master/pipeline.svg)~~
~~![GitLab Coverage](https://gitlab.com/KOLANICH-libs/PerfectPrecomputedHashtable.py/badges/master/coverage.svg)~~
